...
# -----------------------------
# CIFAR-100-C (robustness, identical to holdout version)
# -----------------------------
import tarfile
import urllib.request
import shutil

CIFARC_DIR = os.path.join("./data", "CIFAR-100-C")
...
def build_gaussians_fisher(
    ...
    return dict(mu_f=mu_f, Sig_f_pool=Sig_f_pool, Sig_f_cls=Sig_f_cls, logp=logp)
